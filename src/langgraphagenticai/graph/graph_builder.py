...
class GraphBuilder:
    ...
    def chatbot_with_tools_build_graph(self):
        ...
        # binding the tools and invoking llm for messages
        chatbot_node = chatbot_with_node.create_chatbot(tools=tools)
        ...
        # Add Edges
        self.graph_builder.add_edge(START, "chatbot")
        self.graph_builder.add_conditional_edges("chatbot", tools_condition) # if true goes to Tools , else to END directly
